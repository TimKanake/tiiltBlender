...
def speech_2_text(file_name):
    ...
    with open(file_name, 'rb') as audio_file:
        results = speech_to_text.recognize(
            ...
            word_confidence=True, customization_id="484974ce-bce8-452a-86e2-8bd2d3b1447c")
...
class SpeechDetector:
    ...
    def run(self):
        """
        Listens to Microphone, extracts phrases from it and calls watson speech to text service"""
